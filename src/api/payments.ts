...
export async function paymentControllerPaymentCallback(options?: { [key: string]: any }) {
...
export async function paymentControllerInitPayment(options?: { [key: string]: any }) {
