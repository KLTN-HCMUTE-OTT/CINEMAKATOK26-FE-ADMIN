...
export async function healthControllerGetAggregatedHealth(options?: { [key: string]: any }) {
...
export async function healthControllerGetPaymentHealth(options?: { [key: string]: any }) {
